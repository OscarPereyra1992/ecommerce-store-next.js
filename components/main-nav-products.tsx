...
const MainNavProducts: React.FC<MainNavProps> = ({ data }) => {
      ...
      {isSmallScreen && (
        <>
          <button
            ...
            className="text-white text-md font-medium focus:outline-none relative z-10"
          >
            {menuOpen ? (
...
export default MainNavProducts;