        ...
        <div className="relative z-20">
          <div className="flex flex-col gap-y-8 px-4 sm:px-4 lg:px-6 items-center">
            ...
            <img
              ...
              alt="Imagen 1"
              className="w-24 h-22 sm:w-24 sm:h-22 lg:w-48 lg:h-44 absolute left-[52.84px] top-[190.86px] xsm:absolute xsm:left-[52.84px] xsm:top-[310.73px]"
            />
            <img
            ...
            <img
              ...
              alt="Icono la reina"
              className="w-48 h-40 flex items-center justify-center mx-auto xsm:mt-8 lg:mt-auto"
            />
          </div>
        </div>
